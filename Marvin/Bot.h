...
namespace marvin {
    ...
    public:
        ...
        const std::vector<Vector2f>& GetBasePath() { return base_paths_[ctx_.blackboard.ValueOr<std::size_t>("BaseIndex", 0)]; }
    ...
    private:
        ...
        std::vector<std::string> bot_names{ "LilMarv", "MadMarv", "MarvMaster", "Baked Cake", "Marv1", "Marv2", "Marv3", "Marv4", "Marv5", "Marv6", "Marv7", "Marv8" };

        std::vector<Vector2f> deva0_safes{ Vector2f(32, 56), Vector2f(185, 58), Vector2f(247, 40), Vector2f(383, 64), Vector2f(579, 62), Vector2f(667, 56), Vector2f(743, 97), Vector2f(963, 51),
                                                  ...
                                                  Vector2f(911, 347), Vector2f(97, 425), Vector2f(191, 471), Vector2f(359, 445), Vector2f(688, 392), Vector2f(696, 545), Vector2f(854, 447), Vector2f(16, 558),
         ...
         std::vector<Vector2f> deva1_safes{ Vector2f(102, 56), Vector2f(189, 58), Vector2f(373, 40), Vector2f(533, 64), Vector2f(606, 57), Vector2f(773, 56), Vector2f(928, 46), Vector2f(963, 47),
         ...
         std::vector<Vector2f> HS_entrances = { Vector2f(827, 339), Vector2f(811, 530), Vector2f(729, 893),
                                        Vector2f(444, 757), Vector2f(127, 848), Vector2f(268, 552), Vector2f(181, 330) };


         std::vector<Vector2f> HS_flagrooms = { Vector2f(826, 229), Vector2f(834, 540), Vector2f(745, 828),

...
namespace marvin {
    ...
    namespace deva {
        ...
        const std::vector<Vector2f> team0_safes { Vector2f(32, 56), Vector2f(185, 58), Vector2f(247, 40), Vector2f(383, 64), Vector2f(579, 62), Vector2f(667, 56), Vector2f(743, 97), Vector2f(963, 47),
        ...
        const std::vector<Vector2f> team1_safes { Vector2f(102, 56), Vector2f(189, 58), Vector2f(373, 40), Vector2f(533, 64), Vector2f(606, 57), Vector2f(773, 56), Vector2f(928, 46), Vector2f(963, 51),
